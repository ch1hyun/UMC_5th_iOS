...
//  Catstagram
//
//  Created by Oh Chi Hyun on 2023/10/10.
//
...
class RegisterViewController: UIViewController {
    ...
    @IBOutlet weak var popToLogin: UIButton!
    // Textfields
    ...
    private func setupAttribute() {
        ...
        let attributes = generateButtonAttribute(self.popToLogin, texts: text1, text2,
                                                 fonts: font1, font2,
                                                 colors: color1, color2)
        
        self.popToLogin.setAttributedTitle(attributes, for: .normal)
    }
}
